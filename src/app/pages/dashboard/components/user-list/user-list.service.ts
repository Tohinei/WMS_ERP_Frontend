...
import { SortColumn, SortDirection } from './user-list-sortable.directive';
...
function matches(country: User, term: string, pipe: PipeTransform) {
  ...
  return (
    ...
    country.birthDate.toLowerCase().includes(term.toLowerCase()) ||
...
export class OrdersService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    let usersList: User[] = this.sharedDataService.getUserList() ?? [];
